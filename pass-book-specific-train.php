<?php
    ...
    if(isset($_POST['Book_Train']))
    {
            ...
            */
            ...
            $query="update  RailwayReservationSystem_passenger set pass_train_number = ?, pass_train_name = ?, pass_dep_station = ?, pass_dep_time = ?,  pass_arr_station = ?, pass_train_fare = ? where pass_id=?";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_SESSION['pass_id'];
            $ret="select * from RailwayReservationSystem_passenger where pass_id=?";
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <?php
                        $id=$_GET['id'];
                        $ret="select * from RailwayReservationSystem_train where id=?";
                        $stmt= $mysqli->prepare($ret) ;
