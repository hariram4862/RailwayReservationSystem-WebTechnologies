<?php
    ...
    if(isset($_POST['train_fare_confirm_checkout']))
    {
            ...
            $query="insert into RailwayReservationSystem_train_tickets (pass_name, pass_addr, pass_email, train_name, train_no, train_dep_stat, train_arr_stat,  train_fare, fare_payment_code) values (?,?,?,?,?,?,?,?,?)";
