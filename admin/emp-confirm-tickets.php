<?php
    ...
    if(isset($_POST['train_fare_confirm_checkout']))
    {
            ...
            $query="update RailwayReservationSystem_train_tickets set confirmation = ? where ticket_id = ?   ";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_GET['ticket_id'];
            $ret="select * from RailwayReservationSystem_train_tickets where ticket_id=?";
