<?php
    ...
    if(isset($_POST['Update_Profile']))
    {
            ...
            $query="update  RailwayReservationSystem_admin set admin_fname = ?, admin_lname = ?,  admin_email = ?, admin_uname = ? where admin_id=?";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_SESSION['admin_id'];
            $ret="select * from RailwayReservationSystem_admin where admin_id=?";
