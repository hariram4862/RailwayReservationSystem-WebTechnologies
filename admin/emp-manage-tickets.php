...
if(isset($_GET['del']))
{
      ...
      $adn="delete from RailwayReservationSystem_train_tickets where ticket_id=?";
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        ...
                        */
                        $ret="SELECT * FROM `RailwayReservationSystem_train_tickets` "; //sql code to get all details of trains.
