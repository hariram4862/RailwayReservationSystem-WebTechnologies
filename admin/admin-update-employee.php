 ...
 <?php
	...
	include('assets/inc/config.php');
      ...
      //sql to insert captured values
			$query="update RailwayReservationSystem_employee set emp_fname=?, emp_lname=?, emp_phone=?, emp_addr=?, emp_nat_idno=?, emp_uname=?, emp_email=?, emp_dept=?, emp_pwd=? where emp_id=? ";
  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        ...
        <?php
            $aid=$_GET['emp_id'];
            $ret="select * from RailwayReservationSystem_employee where emp_id=?";
