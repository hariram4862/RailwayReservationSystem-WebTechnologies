...
{
      $id=intval($_GET['del']);
      $adn="delete from RailwayReservationSystem_passenger where pass_id=?";
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        ...
                        */
                        $ret="SELECT * FROM RailwayReservationSystem_passenger"; //sql code to get all details of trains.
