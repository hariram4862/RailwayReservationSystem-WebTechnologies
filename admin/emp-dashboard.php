        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">airline_seat_recline_normal</i></div>
                ...
                <?php
                  ...
                  $result ="SELECT count(*) FROM RailwayReservationSystem_passenger";
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">directions_subway</i></div>
                ...
                <?php
                  ...
                  $result ="SELECT count(*) FROM RailwayReservationSystem_train";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">rowing</i></div>
                ...
                <?php
                    ...
                    $result ="SELECT count(*) FROM `RailwayReservationSystem_train_tickets` ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">supervisor_account</i></div>
                ...
                <?php
                  //code for summing up number of passengers 
                  $result ="SELECT count(*) FROM RailwayReservationSystem_employee";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              ...
              <div class="chart sparkline"><i class="material-icons">person</i></div>
                ...
                <?php
                  //code for summing up number of passengers 
                  $result ="SELECT count(*) FROM RailwayReservationSystem_admin ";  
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
            ...
            <!-- <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline"><i class="material-icons">local_activity</i></div>
                ...
                <?php
                  //code for summing up number of passengers 
                  $result ="SELECT count(*) FROM RailwayReservationSystem_passwordresets where status = 'Pending' ";  
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  $stmt->bind_result($pass);
                  $stmt->fetch();
            ...
            <div class="col-12 col-lg-6 col-xl-4">
              ...
              <div class="chart sparkline"><i class="material-icons">loyalty</i></div>
                ...
                <?php
                  //code for summing up number of trains tickets
                  $result ="SELECT count(*) FROM RailwayReservationSystem_train_tickets where confirmation = 'Approved'";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        ...
                        $ret="SELECT * FROM RailwayReservationSystem_train ORDER BY RAND() LIMIT 10 "; //sql code to get to ten trains randomly
              ...
              <div class="card card-table">
                ...
                <!--Start Table-->
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        $ret="SELECT * FROM RailwayReservationSystem_train_tickets WHERE confirmation ='Approved' LIMIT 10";
                        $stmt= $mysqli->prepare($ret) ;
                        $stmt->execute() ;//ok
                        $res=$stmt->get_result();
                        $cnt=1;
              ...
              <div class="card card-table">
                ...
                <!--Start Table-->
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <tbody>
                      <?php
                        $ret="SELECT * FROM RailwayReservationSystem_employee ORDER BY RAND() LIMIT 10  "; //sql code to get all details of all employees
                        $stmt= $mysqli->prepare($ret) ;
                        $stmt->execute() ;//ok
                        $res=$stmt->get_result();
                        $cnt=1;
