...
--
-- Table structure for table `RailwayReservationSystem_admin`
--

CREATE TABLE `RailwayReservationSystem_admin` (
...
--
-- Dumping data for table `RailwayReservationSystem_admin`
--

INSERT INTO `RailwayReservationSystem_admin` (`admin_id`, `admin_fname`, `admin_lname`, `admin_email`, `admin_uname`, `admin_pwd`, `admin_dpic`) VALUES
(1, 'System ', 'Admin', 'admin@mail.com', 'Administrator', '903b21879b4a60fc9103c3334e4f6f62cf6c3a2d', 'admin-icn.png');

-- --------------------------------------------------------

--
-- Table structure for table `RailwayReservationSystem_employee`
--

CREATE TABLE `RailwayReservationSystem_employee` (
...
--
-- Dumping data for table `RailwayReservationSystem_employee`
--

INSERT INTO `RailwayReservationSystem_employee` (`emp_id`, `emp_fname`, `emp_lname`, `emp_nat_idno`, `emp_phone`, `emp_addr`, `emp_uname`, `emp_email`, `emp_pwd`, `emp_dpic`, `emp_dept`) VALUES
(1, 'John', 'Deacon', '866861970', '+31024579651', '79 Green Avenue', 'deacon', 'employee@mail.com', 'emp123', 'defaultimg.jpg', 'Train Captain');

-- --------------------------------------------------------

--
-- Table structure for table `RailwayReservationSystem_passenger`
--

CREATE TABLE `RailwayReservationSystem_passenger` (
...
--
-- Dumping data for table `RailwayReservationSystem_passenger`
--

INSERT INTO `RailwayReservationSystem_passenger` (`pass_id`, `pass_fname`, `pass_lname`, `pass_phone`, `pass_addr`, `pass_email`, `pass_pwd`, `pass_dpic`, `pass_uname`, `pass_bday`, `pass_bio`, `pass_train_number`, `pass_train_name`, `pass_dep_station`, `pass_dep_time`, `pass_arr_station`, `pass_train_fare`, `pass_fare_payment_code`) VALUES
...
--
-- Table structure for table `RailwayReservationSystem_passwordresets`
--

CREATE TABLE `RailwayReservationSystem_passwordresets` (
...
--
-- Dumping data for table `RailwayReservationSystem_passwordresets`
--

INSERT INTO `RailwayReservationSystem_passwordresets` (`pwd_id`, `email`, `status`) VALUES
...
--
-- Table structure for table `RailwayReservationSystem_train`
--

CREATE TABLE `RailwayReservationSystem_train` (
  `id` int(20) NOT NULL,
...
--
-- Dumping data for table `RailwayReservationSystem_train`
--

INSERT INTO `RailwayReservationSystem_train` (`id`, `name`, `route`, `current`, `destination`, `time`, `passengers`, `number`, `fare`) VALUES
...
--
-- Table structure for table `RailwayReservationSystem_train_tickets`
--

CREATE TABLE `RailwayReservationSystem_train_tickets` (
...
--
-- Dumping data for table `RailwayReservationSystem_train_tickets`
--

INSERT INTO `RailwayReservationSystem_train_tickets` (`ticket_id`, `pass_name`, `pass_email`, `pass_addr`, `train_name`, `train_no`, `train_dep_stat`, `train_arr_stat`, `train_fare`, `fare_payment_code`, `confirmation`) VALUES
...
--
-- Indexes for table `RailwayReservationSystem_admin`
--
ALTER TABLE `RailwayReservationSystem_admin`
  ADD PRIMARY KEY (`admin_id`);

--
-- Indexes for table `RailwayReservationSystem_employee`
--
ALTER TABLE `RailwayReservationSystem_employee`
  ADD PRIMARY KEY (`emp_id`);

--
-- Indexes for table `RailwayReservationSystem_passenger`
--
ALTER TABLE `RailwayReservationSystem_passenger`
  ADD PRIMARY KEY (`pass_id`);

--
-- Indexes for table `RailwayReservationSystem_passwordresets`
--
ALTER TABLE `RailwayReservationSystem_passwordresets`
  ADD PRIMARY KEY (`pwd_id`);

--
-- Indexes for table `RailwayReservationSystem_train`
--
ALTER TABLE `RailwayReservationSystem_train`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `RailwayReservationSystem_train_tickets`
--
ALTER TABLE `RailwayReservationSystem_train_tickets`
...
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_admin`
--
ALTER TABLE `RailwayReservationSystem_admin`
  MODIFY `admin_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_employee`
--
ALTER TABLE `RailwayReservationSystem_employee`
  MODIFY `emp_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_passenger`
--
ALTER TABLE `RailwayReservationSystem_passenger`
  MODIFY `pass_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_passwordresets`
--
ALTER TABLE `RailwayReservationSystem_passwordresets`
  MODIFY `pwd_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_train`
--
ALTER TABLE `RailwayReservationSystem_train`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `RailwayReservationSystem_train_tickets`
--
ALTER TABLE `RailwayReservationSystem_train_tickets`
