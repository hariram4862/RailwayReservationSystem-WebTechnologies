...
<?php
    ...
    if(isset($_POST['emp_login']))
    {
      ...
      $emp_pwd=$_POST['emp_pwd'];//double encrypt to increase security
      $stmt=$mysqli->prepare("SELECT emp_email ,emp_pwd , emp_id FROM RailwayReservationSystem_employee WHERE emp_email=? and emp_pwd=? ");//sql to log in user
